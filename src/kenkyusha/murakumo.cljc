...
(defn collection
  [name]
  (str "com.etzhayyim.kenkyusha." name))

(def cell-specs {
  :stats {:legacy-cell "com-etzhayyim-apps-kenkyusha-stats"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "stats")]
     :required-gates common-gates
     :trigger "manifest cell stats"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :seeddisciplines {:legacy-cell "com-etzhayyim-apps-kenkyusha-seedDisciplines"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "seeddisciplines")]
     :required-gates common-gates
     :trigger "manifest cell seeddisciplines"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :get {:legacy-cell "com-etzhayyim-apps-kenkyusha-coverage-get"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :bunken {:legacy-cell "com-etzhayyim-apps-bunken-bunken"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "bunken")]
     :required-gates common-gates
     :trigger "manifest cell bunken"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :book {:legacy-cell "com-etzhayyim-isbn-book"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "book")]
     :required-gates common-gates
     :trigger "manifest cell book"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :serial {:legacy-cell "com-etzhayyim-apps-issn-serial"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "serial")]
     :required-gates common-gates
     :trigger "manifest cell serial"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
